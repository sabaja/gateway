 ...
 *
 */
public class MultiplicationHystrixFallbackProvider implements FallbackProvider {
	...
	public ClientHttpResponse fallbackResponse(String route, Throwable cause) {
		return new ClientHttpResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				return new ByteArrayInputStream("Sorry, service is Unavailable, Please try after sometimes"
